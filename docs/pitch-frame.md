...
The pitch frame shares its origin with the world frame, so transforming between them is a pure rotation. No translation is involved. The practical value of this frame is that spin axes have intuitive, arm-slot-independent descriptions:
